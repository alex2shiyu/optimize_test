...
! call hybrj1(fsolve_hybrj1_func2sub,n,x,fvec,fjac,n,tol_,info_)
  call hybrj1(n,x,fvec,fjac,n,tol_,info_)
...
! call fcn ( n, x, fvec, fjac, ldfjac, iflag )
  call fsolve_hybrj1_func2sub ( n, x, fvec, fjac, ldfjac, iflag )
  nfev = 1
...
!       call fcn ( n, wa2, wa4, fjac, ldfjac, iflag )
        call fsolve_hybrj1_func2sub ( n, wa2, wa4, fjac, ldfjac, iflag )
        nfev = nfev + 1
        if ( iflag < 0 ) go to 300
        fnorm1 = enorm ( n, wa4 )
!
...
!subroutine hybrj1 ( fcn, n, x, fvec, fjac, ldfjac, tol, info )
 subroutine hybrj1 ( n, x, fvec, fjac, ldfjac, tol, info )
! interface
!     subroutine fcn(n,x,fvec,fjac,ldfjac,iflag)
!         integer ::  n
!         real(8) ::  x(n)
...
!   factor, nprint, info, nfev, njev, r, lr, qtf )
  call hybrj ( n, x, fvec, fjac, ldfjac, xtol, maxfev, diag, mode, &
    factor, nprint, info, nfev, njev, r, lr, qtf )
